...
from src.main.controllers.mongodb_controller_insert import MongodbControllerInsert


def mongodb_composer_insert():
    ...
    controller = MongodbControllerInsert(use_case=database_mongodb_service)
